class Badger < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "7b84c68639b5da18bc10873269754b7d61ab92f7a9a1348e1d7cd135464d99da"
    end

    on_intel do
      url "https://github.com/PVRLabs/aibadger/releases/download/v#{version}/badger_#{version}_darwin_amd64.tar.gz"
      sha256 "8ef27b8e3aa2310e51daff52ef0268de4f3853902b38895a7b8d9627a406db56"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "8c66c39a8d0f1f57ebcd2ef87ad30bd99d3dbf2fb2e399b9b9bf2bc7a713356c"
    end

    on_intel do
      url "https://github.com/PVRLabs/aibadger/releases/download/v#{version}/badger_#{version}_linux_amd64.tar.gz"
      sha256 "f320a83e178d398752b287f224b787380bf83add51c6c648c77c10242d94f4dc"
    end
  end
